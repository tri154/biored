...
def _is_eight_considered_ne_pairs(ne1_type, ne2_type):
    ...
    if ne1_type == 'ChemicalEntity' and ne2_type == 'ChemicalEntity':
        ...
        return True
    elif ne1_type == 'DiseaseOrPhenotypicFeature' and ne2_type == 'SequenceVariant':
        return True
    elif ne1_type == 'ChemicalEntity' and ne2_type == 'SequenceVariant':
        return True
    elif ne1_type == 'SequenceVariant' and ne2_type == 'SequenceVariant':
        return True
...
def dump_pred_2_pubtator_file(in_test_pubtator_file,
    ...
    if pmid_2_rel_pair_2_novelty_dict is None:
        pmid_2_rel_pair_2_novelty_dict = dict()
                    ...
                    if len(tks) == 5 or len(tks) == 4:
                        ...
                        for id1 in re.split(re_id_spliter_str, tks[2]):
                            for id2 in re.split(re_id_spliter_str, tks[3]):
                                ...
                                # if not _is_eight_considered_ne_pairs(ne_type1, ne_type2):
                                #   continue
